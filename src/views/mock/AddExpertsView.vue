<template>
    <div class="p-8 min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 mx-auto max-w-4xl">
        <div class="bg-white p-8 rounded-xl shadow-md">
            ...
            <button class="px-4 py-2 font-bold text-white bg-blue-500 rounded transition duration-150 ease-in-out hover:bg-blue-700 focus:outline-none focus:shadow-outline" @click="addUserToFirebase">
                Agregar
            </button>
        </div>
    </div>
